...
var getRestResult = function(URL) {
    ...
    URL = URL.toString();
    rest.get("http://"+URL).on('complete', function (result,response) {
        ...
        if (result instanceof Error) {
	     ...
	     fs.writeFileSync(URL,result);
             var checkJson = checkHtmlFile(program.url, program.checks);console.log("printed in case result came back correct \n");
